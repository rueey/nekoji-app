...
public class AnimePageLoader extends AsyncTaskLoader<Anime> {
    private Anime mData;
    private String id;
    public AnimePageLoader(Context context, String id) {
        super(context);
        this.id = id;
    }
    @Override
    ...
    /********************************************************/
    @Override
    public void deliverResult(Anime data) {
        if (isReset()) {
    ...
    @Override
    public void onCanceled(Anime data) {
    ...
    private void releaseResources(Anime data) {
