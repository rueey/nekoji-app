...
public class AnimeScheduleLoader extends AsyncTaskLoader<AnimeList> {
    ...
    private String year;
    private int asc;
    public AnimeScheduleLoader(Context context, String status, String season, String year, int sort, int asc) {
        super(context);
        this.sort = sort;
        this.asc = asc;
        this.status = status;
    ...
    public AnimeList loadInBackground() {
        AnimeList result = AnimeListBuilder.buildScheduleList(season + " " + year, status, sort, asc);
        mData = result;
        return result;
    }
    /********************************************************/
